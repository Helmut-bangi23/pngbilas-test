...
<body>
  ...
  <div class="row mt-1 mb-1 justify-content-center">
    <div class="col-md-12 text-center">
      <h5><a href="index.php" style="text-decoration: none; font-weight: bold;">Return Home</a></h5>
    </div>
  </div>
              ...
              <tbody>
                ...
                if ($result && mysqli_num_rows($result) > 0) {
                  while ($row = mysqli_fetch_assoc($result)) {
                    ...
                    echo "<td style='text-align:center;'><img src='/E-Commerce/admin/index/img/uploads/" . htmlspecialchars($row['product_image']) . "' class='img-thumbnail' height='50px' width='50px'></td>";
