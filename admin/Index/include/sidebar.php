<div class="container-fluid main">
		<div class="row">
			<div class="col-md-2 col-sm-12 top-left m-0 p-0">
				<div class="logo-area">
					<img src="/E-commerces/E-Commerce/Home/Images/logos.png" alt="..." height="90px" width="130px">
				...
				<div class="das_icon" id="navi">
					<nav>
						<a href="#"
							style="background-color: #e8f0cdff; color: #4649FF; margin-right: 14px; border-radius: 5px;"><i
