...
// ✅ Total Deliveries
$sql_deliveries = "SELECT COUNT(*) AS total_deliveries FROM ordered WHERE status = 'Delivered'";
$res_deliveries = mysqli_query($conn, $sql_deliveries);
...
<div class="container-fluid body-area mt-5">
    ...
    <div class="row">
        ...
        <div class="col-md-3 col-sm-6 card-area mt-3">
            <div class="card">
                <div class="parent">
                    <div class="icon"><i class="fas fa-shopping-cart" id="icon"></i></div>
        ...
        <div class="col-md-3 col-sm-6 card-area mt-3">
            <div class="card">
                <div class="parent">
                    <div class="icon"><i class="fas fa-shopping-bag" id="icon2"></i></div>
                    <div class="total-area2">
        ...
        <div class="col-md-3 col-sm-6 card-area mt-3">
            <div class="card">
                <div class="parent">
                    <div class="icon"><i class="fas fa-truck" id="icon3"></i></div>
                    <div class="total-area2">
                        <p class="text-muted pt-4">Total Deliveries</p>
                        <h6><?php echo $total_deliveries; ?></h6>
                    </div>
                </div>
            </div>
        </div>
                        ...
                        echo "<tr>
                                ...
                                <td>
                                    <form method='post' action='update_order_status.php' style='display:inline-block;'>
                                        ...
                                        <button type='submit' name='action' value='Delivered' class='btn btn-success btn-sm'>Delivered</button>
                                    </form>
                                    <form method='post' action='update_order_status.php' style='display:inline-block;'>
                                        <input type='hidden' name='order_id' value='{$row['ID']}'>
                                        <button type='submit' name='action' value='Pending' class='btn btn-warning btn-sm'>Yet to Deliver</button>
                                    </form>
                                </td>
                              </tr>";
                    }
